function enviar (){
    ...
    if(nombre.value ==""){
     ...
     if(email.value ==""){
        document.querySelector("#email + p").innerHTML ="Debe rellenar el campo email"
    ...
    if(email.value !=""){
            if(patron.test(email.value)){
                ...
                document.querySelector("#email + p").innerHTML ="El email no es valido"
                email.classList.add("rojo")
                cEmail = false; 
            }
     ...
     if(asunto.value ==""){
        document.querySelector("#asunto + p").innerHTML = "Debe rellenar el campo asunto"
        asunto.classList.add("rojo")
         cAsunto = false;
    }
     if(servicios.value ==""){
        document.querySelector("#servicios + p").innerHTML = "Debe rellenar el campo servicios"
        servicios.classList.add("rojo")
        cServicios = false;
    }
     if(mensaje.value ==""){
        document.querySelector("#mensaje + p").innerHTML = "Debe rellenar el campo mensaje"
