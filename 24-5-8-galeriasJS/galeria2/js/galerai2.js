...
let puntos = document.querySelector(".puntos div i")

document.querySelector("#atras").addEventListener
("click", retroceder);
document.querySelector("#adelante").addEventListener
("click", avanzar);
let numFoto =0;
function retroceder(){
    numFoto--
    ...
    puntos[numFoto].classList.replace("bi-circle-fill","bi-circle")
}
